...
{
    public class InventorySlot : Avalonia.Controls.Button  //was System.Windows.Forms.Button
    {
        ...
        public Image DisplayItemImage(Boolean large)
        {
            ...
            if (large)
            {
                ...
                {
                    return new Bitmap(Leaf, 128, 128);
                }
                else if (itemID == 0x16A2) //recipe
                {
                    ...
                    if (recipe != null)
                    {
                        Image icon = (new Bitmap(recipe, imageSize, imageSize));

                        //Image img = PlaceImageOverImage(background, icon, background.Width - imageSize - 10, background.Width - imageSize - 10, 1);

                        return new Bitmap(img, 128, 128);
                    }
                    else
                        return new Bitmap(background, 128, 128);
                }
                else if (itemID == 0x315A || itemID == 0x1618 || itemID == 0x342F || itemID == 0x114A || itemID == 0xEC9C) // Wall-Mount/Money Tree
                {
                    if (File.Exists(containItemPath))
                    {
                        ...
                        Image icon = (new Bitmap(ImageCacher.GetImage(containItemPath), imageSize, imageSize));
            ...
            else
            {
                if (imagePath == "" & itemID != 0xFFFE)
                {
                    return new Bitmap(Properties.Resources.Leaf, 64, 64);
                }
                else if (itemID == 0x315A || itemID == 0x1618 || itemID == 0x342F || itemID == 0x114A || itemID == 0xEC9C) // Wall-Mount/Money Tree
                {
                    if (File.Exists(containItemPath))
                ...
                else if (itemID == 0x16A2) // recipe
                {
                    ...
                    if (recipe != null)
                    {
                        ...
                        return new Bitmap(background, 64, 64);
